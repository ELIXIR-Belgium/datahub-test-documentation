...
```
![]({{ site.baseurl }}/images/user-guide/extended-metadata/atrribute_string_type.png)
{:.screenshot}
...
```
![]({{ site.baseurl }}/images/user-guide/extended-metadata/attribute_text_type.png)
{:.screenshot}
...
```
![]({{ site.baseurl }}/images/user-guide/extended-metadata/attribute_date_type.png)
{:.screenshot}
...
```
![]({{ site.baseurl }}/images/user-guide/extended-metadata/attribute_time_type.png)
{:.screenshot}
...
```
![]({{ site.baseurl }}/images/user-guide/extended-metadata/attribute_integer_type.png)
{:.screenshot}
...
```
![]({{ site.baseurl }}/images/user-guide/extended-metadata/attribute_real_number_type.png)
{:.screenshot}
...
```
![]({{ site.baseurl }}/images/user-guide/extended-metadata/attribute_boolean_type.png)
{:.screenshot}
...
![]({{ site.baseurl }}/images/user-guide/extended-metadata/attribute_cv_type.png)
{:.screenshot}
...
```
![]({{ site.baseurl }}/images/user-guide/extended-metadata/attribute_cvlist_type.png)
{:.screenshot}
...
```
![]({{ site.baseurl }}/images/user-guide/extended-metadata/attribute_nested_type.png)
{:.screenshot}
